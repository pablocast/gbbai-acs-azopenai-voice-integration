...
from src.services.openai_realtime_service import init_websocket, start_conversation, process_websocket_message_async
...
async def ws():
    ...
    await start_conversation(instructions, azure_openai_service_endpoint, azure_openai_service_key, azure_openai_deployment_model_name)
    while True:
        try:
