...
async def ws():
    ...
    client = AzureRealtimeWebsocket(
        service_id='audio-agent',
        deployment_name=os.environ["AZURE_OPENAI_DEPLOYMENT_MODEL_NAME"],
        api_key=os.environ["AZURE_OPENAI_SERVICE_KEY"],
        endpoint=os.environ["AZURE_OPENAI_SERVICE_ENDPOINT"],
