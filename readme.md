...
<br>
<div align="center">
  <img src="./utils/media/repo_call_automation_3.png" alt="Connect" style="width:500px;"/>
</div>
<br>
...
3. **Azure OpenAI**: Generates text responses to user inputs using large language models.
